...
label_gen_open : label_gen_mod.LabelGenerator = label_gen_mod.Barrier101AbsChangeLabel(upper_barrier = 3.0, max_holding_period = 4, criteria = data.BarDataColumns.OPEN)
label_gen_close : label_gen_mod.LabelGenerator = label_gen_mod.Barrier101AbsChangeLabel(upper_barrier = 3.0, max_holding_period = 1, criteria = data.BarDataColumns.CLOSE)
label_gen_high : label_gen_mod.LabelGenerator = label_gen_mod.Barrier101AbsChangeLabel(upper_barrier = 1.5, max_holding_period = 4, criteria = data.BarDataColumns.HIGH)
label_gen_low : label_gen_mod.LabelGenerator = label_gen_mod.Barrier101AbsChangeLabel(upper_barrier = 3.0, max_holding_period = 5, criteria = data.BarDataColumns.LOW)
label_gen_vwap : label_gen_mod.LabelGenerator = label_gen_mod.Barrier101AbsChangeLabel(upper_barrier = 3.0, max_holding_period = 3, criteria = data.BarDataColumns.VWAP)
