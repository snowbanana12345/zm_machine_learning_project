...
class TestBarrier110AbsChangeLabel(unittest.TestCase):
    def setUp(self):
        self.test_symbol: str = "TEST"
        bar1 = {open_str: 25, close_str: 25, high_str: 25, low_str: 25, timestamp_str: 1, vol_str: 412, vwap_str: 25}
        bar2 = {open_str: 29, close_str: 27.99, high_str: 28.01, low_str: 25, timestamp_str: 2, vol_str: 592,
                vwap_str: 25}
        bar3 = {open_str: 25, close_str: 22, high_str: 21.99, low_str: 27.9, timestamp_str: 3, vol_str: 239,
                vwap_str: 35}
        bar4 = {open_str: 22, close_str: 25, high_str: 25, low_str: 22, timestamp_str: 4, vol_str: 352, vwap_str: 20}
        bar5 = {open_str: 25, close_str: 22.01, high_str: 21.99, low_str: 22, timestamp_str: 5, vol_str: 439,
                vwap_str: 20}
        bar6 = {open_str: 25, close_str: 28, high_str: 28.01, low_str: 19.1, timestamp_str: 6, vol_str: 239,
                vwap_str: 22}
        ...
        bar12 = {open_str: 22, close_str: 28, high_str: 22, low_str: 27.999, timestamp_str: 12, vol_str: 401,
                 vwap_str: 100}
        ...
        self.label_gen_open: label_gen_mod.LabelGenerator = label_gen_mod.Barrier110AbsChangeLabel(upper_barrier=4.0,
                                                                                              lower_barrier=3.0,
                                                                                              criteria=data.BarDataColumns.OPEN)
        self.label_gen_close: label_gen_mod.LabelGenerator = label_gen_mod.Barrier110AbsChangeLabel(upper_barrier=3.0,
                                                                                               lower_barrier=3.0,
                                                                                               criteria=data.BarDataColumns.CLOSE)
        self.label_gen_high: label_gen_mod.LabelGenerator = label_gen_mod.Barrier110AbsChangeLabel(upper_barrier=3.0,
                                                                                              lower_barrier=3.0,
                                                                                              criteria=data.BarDataColumns.HIGH)
        self.label_gen_low: label_gen_mod.LabelGenerator = label_gen_mod.Barrier110AbsChangeLabel(upper_barrier=3.0,
                                                                                             lower_barrier=3.0,
                                                                                             criteria=data.BarDataColumns.LOW)
        self.label_gen_vwap: label_gen_mod.LabelGenerator = label_gen_mod.Barrier110AbsChangeLabel(upper_barrier=3.0,
                                                                                              lower_barrier=3.0,
