...
col_name : data.BarDataColumns = data.BarDataColumns.VWAP
threshold = 20
...
# ----- filter class ------
filter_gen : filter_gen_mod.FilterGenerator = filter_gen_mod.SymmetricAbsPriceCumSum(threshold = threshold, criteria = col_name)
